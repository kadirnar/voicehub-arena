...
|---|---:|---:|---:|
| seedtts_en | 1,088 | 23 | 0 |

Etkin kapsam: **v1 · Seed-TTS-Eval English · 5 models**.
Her model için önce 32 metin/bölüm pilotu, sonra 256 metin/bölüm paneli, ardından kalan bütün metinler çalışır.
Panel: 256 metin/model; tam kapsam: 1,088 metin/model, toplam 5,440 ses. Üretim seed42 ve tek tekrarlıdır.
