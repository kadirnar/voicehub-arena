...
These historical notes document the original RTX 3090 integration and repair work.
The original campaign is stopped. Completion statements below concern diagnostic
runs, not the full Seed-TTS-Eval dataset or a new GPU. Operational setup is in the
